...
The test scheme and UI tests set `POSTY_TESTING=1`, giving each test process a separate Keychain namespace and disabling the real local store. Avoid launching ad-hoc builds against your real saved connections.
